...
Prod-Build folder should contain a built project that you should be able to run
Go to /Prod-Build/ and double click on JumpingJack.exe
Download build
Download file at Google Drive Link
Extract the project
Go to /Prod-Build/ and double click on JumpingJack.exe
Build project yourself or launch it in the Unity editor
Download and install the correct Unity build at Unity Download Archive
Clone this repository
Open the project in Unity
Play in editor or build and run
CONTROLS
Player Controls:
